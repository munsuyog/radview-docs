...
![](../images/managing-tests/managing-tests1.png)
...
| ![View Last Session](../images/managing-tests/managing-tests-view-last.png) | Enables viewing the last session of this test. Selecting this option opens a Dashboard page displaying the last session of the test. Refer to *Using Dashboards* (on page 36). |
| ![Run Now](../images/managing-tests/managing-tests-run.png) | Enables manually running this test now or at a specified time. Refer to *Scheduling a one-time test run* (on page 25). |
| ![Stop Test](../images/managing-tests/managing-tests-stop.png) | Instructs WebLOAD to stop the running test. |
| ![View All Sessions](../images/managing-tests/managing-tests-view-all.png) | Enables viewing all this test's sessions. Selecting this option opens a Load Sessions page (Figure 23) that displays all of this test's sessions. |
| ![Delete Test](../images/managing-tests/managing-tests-delete.png) | Instructs WebLOAD to delete the load test. Refer to *Deleting a load test* (on page 27). |
...
1. Perform one of the following: 
    ...
    ![Selecting the type of load test to create](../images/managing-tests/managing-tests-type-of-load.png)
...
2. Select URL/API Test.
    ...
    ![Creating a URL/API load test](../images/managing-tests/managing-tests-create-api.png)
...
2. Select **Script Test**.
    ...
    ![Creating a Script load test](../images/managing-tests/create-script-load-test.png)
...
1. For every script you want to include in the Script Load test, click **Add Script**.
    ![Selecting to add a script to a Script Load Test](../images/managing-tests/add-a-script.png)

    The **Scripts** page appears. 

    ![Selecting a script in the Scripts page](../images/managing-tests/select-script.png)
...
2. Select a script by clicking Select Script in the corresponding line. 
    ...
    ![List of scripts participating in a Script Load Test](../images/managing-tests/list-of-scripts.png)
...
2. Select **Template Test**. 
    ...
    ![Creating a Template load test](../images/managing-tests/template-load-test.png)
...
2. Select a group of load generators with an identical Location by entering a non-zero percentage in the corresponding **%** column. The percentage specifies the relative weight of this group of load generators.
    ...
    ![List of available load generators](../images/managing-tests/available-load-generators.png)
...
3. Make sure the sum of all the percentages is 100%.
    ...
    ![Specifying the load generators participating in a load test ](../images/managing-tests/specifying-load-generators.png)
...
1. In the Create Load Test page, accessed as described in *Creating a New Load Test* (on page 13), select the **Recurrence** checkbox.
    ...
    ![Setting test recurrence](../images/managing-tests/setting-test-recurrence.png)
...
1. In the menu bar, select **Tests** > **Search**.
   ...
   ![Load Tests page](../images/managing-tests/load-tests.png)

2. In the line corresponding to the test you wish to run, click ![Run Test](../images/managing-tests/managing-tests-run.png). A Run Test query is displayed.

   ![Run Test query](../images/managing-tests/run-test-query.png)
...
3. Do one of the following:
   ...
   ![Specifying to run a load test at a later time ](../images/managing-tests/specifying-run-test.png)
...
1. In the menu bar, select **Tests** > **Search**.
   ...
   ![Load Tests page](../images/managing-tests/update-load-test.png)
...
2. In the line corresponding to the test you wish to delete, click ![](../images/managing-tests/managing-tests-delete.png).

    A Delete Test page appears.

    ![Deleting a load session](../images/managing-tests/delete-test-page.png)
